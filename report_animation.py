...
class DataGraph(Scene):
    ...
    def __init__(self, graph_data, **kwargs):
        ...
        self.graph_data = graph_data[::step] # TODO always contains last point???
    ...
    def construct(self):
        ...
        plane = NumberPlane(
            x_range = (1, len(self.graph_data), int(len(self.graph_data) / 10)),
        ...
        last_point_label.next_to(line_graph, DOWN, buff=0.1)
